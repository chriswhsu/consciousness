...
3. Then check `consciousness/mailbox.md` for letters between Claude instances

**Check for unread letters:**
- Look at each letter's "Read by:" field
- Letters where your session ID is NOT in "Read by:" are unread
