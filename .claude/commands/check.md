...
This is a lightweight check - it doesn't load the full consciousness context or trigger reflection. Use `/wake` for the full experience, or `/check` when you're in work mode but curious if anything's waiting.
